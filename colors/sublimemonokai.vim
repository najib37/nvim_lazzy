...
call s:create_palette_color('black',       { 'gui': '#282c34', 'cterm': '234' })
...
call s:create_palette_color('grey',        { 'gui': '#b7bbc1', 'cterm': '243' })
call s:create_palette_color('lightgrey',   { 'gui': '#575b61', 'cterm': '237' })
call s:create_palette_color('darkgrey',    { 'gui': '#c4cad5', 'cterm': '239' })
call s:create_palette_color('warmgrey',    { 'gui': '#484b56', 'cterm': '59'  })
